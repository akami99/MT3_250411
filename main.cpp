...
const char kWindowTitle[] = "LE2B_01_アカミネ_レン_MT3_00_03";
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	Matrix4x4 trasnlateMatrix = MakeTranslationMatrix(translate);
	...
	while (Novice::ProcessMessage() == 0) {
		...
		MatrixScreenPrintf(0, kRowHeight, trasnlateMatrix, "trasnlateMatrix");
